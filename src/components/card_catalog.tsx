...
export default function CatalogCard({img, price, description, barprice, devise = "FCFA", width = 180}:{img:string | StaticImport, price:number, description:string, barprice:number, devise?:string, width?:number}){
    return (
